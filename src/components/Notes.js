    ...
    return (
        <>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form>
                                <div className="mb-3">
                                    <label htmlFor="etitle" className="form-label">Title/Official Name</label>
                                ...
                                <div className="mb-3">
                                    <label htmlFor="edescription" className="form-label">Description/Designation</label>
                                ...
                                <div className="mb-3">
                                    <label htmlFor="etag" className="form-label">Perks/Comments</label>
                        ...
                        <div className="modal-footer">
                            ...
                            <button disabled={note.etitle.length<5 || note.edescription.length<5} onClick={handleClick} type="button" className="btn btn-primary">Update Profile</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="row my-3">
                <h1>Your Profiles</h1>
                {notes.length===0 && <h2>No Profiles to display</h2>}
                {notes.map((note) => {
